...
<div>
    ...
    <div class="card">
        ...
        <div class="mb-4 flex justify-end">
            <div>
                @if(can('add_users'))
                <livewire:admin.usuarios.administradores.create />
                @endif
            </div>
        </div>
        <div class="grid items-center grid-cols-1 gap-0 md:grid-cols-4 md:gap-4">
            <div class="col-span-1 md:col-span-3">
                <x-form.input type="search" name="search" wire:model="search" label="none" class="mt-0 md:mt-2" placeholder="Buscar administradores">
    ...
    <div class="card">
        <h3 class="mb-4">Listado de Administradores</h3>
        <div class="bg-primary text-gray-50 py-2 px-4 my-5 rounded-md">
            <i class="fa-solid fa-circle-info"></i> De forma predeterminada, el administrador raiz no puede eliminarse.
        </div>
            ...
            <table class="table-auto">
                <thead>
                    <tr class="border border-slate-200">
                        ...
                        <th class="border border-slate-200">Roles</th>
                            ...
                            <div class="flex space-x-2">
                                ...
                                <div>
                                    <x-modal>
                                        ...
                                        <x-slot name="title">Administrador</x-slot>
                                            ...
                                            <x-tab name="datosuser">
                                                ...
                                                <x-tabs.div name="datosuser">
                                                    ...
                                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                                        ...
                                                        <div class="w-full">
                                                            <x-form.select label="Oficina" wire:model="oficina_id" disabled>
                                                                <x-form.select-option selected>Seleccionar</x-form.select-option>
                                                    ...
                                                    <div class="border border-slate-200 rounded py-4 px-2 grid grid-cols-2 gap-4 md:grid-cols-3">
                                                        ...
                                                        <div class="w-full">
                                                            <x-form.checkbox wire:model="rolesSelected" :label="$role->label" :wire:key="$role->id" value="{{ $role->id }}" disabled />
                                                        </div>
                                                        @endforeach
                                                    </div>
                                                </x-tabs.div>
                                ...
                                <div>
                                    <x-modal>
                                        ...
                                        <x-slot name="title">Editar Administrador</x-slot>
                                    ...
                                    <x-modal>
                                        ...
                                        <x-slot name="content">
                                            <div class="text-center">
                                                El administrador <b>{{ $item->name }}</b> se eliminará de manera permanente
                                            </div>
                                        </x-slot>
