...
<div>
    ...
    <div class="card">
        ...
        <div class="mb-4 flex justify-end">
            <div>
                <livewire:admin.colegios.capitulos.create />
            </div>
        </div>
    ...
    <div class="card">
        ...
        <h3 class="mb-4">Listado de Capítulos</h3>
        ...
        <div class="mb-4 overflow-auto">
            <table>
                ...
                <tbody>
                    @foreach($this->capitulos() as $item)
                    <tr class="border border-slate-200">
                                ...
                                <x-modal>
                                    ...
                                    <x-slot name="content">
                                        <div class="text-center">
                                            El capítulo <b>{{ $item->denominacion }}</b> se eliminará permanentemente
                                        </div>
                                    </x-slot>
