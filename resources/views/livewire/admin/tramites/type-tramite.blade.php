...
<div>
    <h1>Tipo de tramites</h1>
    <div class="card">
        @include('errors.messages')
        <div class="mb-4 flex justify-end">
            <div>
                <livewire:admin.tramites.typetramite-create/>
    ...
    <div class="card">
        ...
        <h3 class="mb-4">Listado de tipo de tramites</h3>
        ...
        <div class="mb-4 overflow-auto">
            <table>
                ...
                <tbody>
                    @foreach($this->tipotramites() as $item)
                    <tr class="border border-slate-200">
