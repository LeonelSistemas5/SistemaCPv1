...
<div>
    ...
    <div class="card">
        ...
        <h4 class="mb-4">Participantes del curso <b><em>"{{ $this->inscritos()[0]->Curso->denominacion }}"</em></h4></b>

        <div class="mb-4 overflow-auto">
            <table>
                <thead>
                    <tr class="border border-slate-200">
                        <th class="border border-slate-200 uppercase">Código</th>
                ...
                <tbody>
                    ...
                    <tr class="border border-slate-200">
                        ...
                        <td class="border border-slate-200">{{ $item->User->Colegiado->codigo }}</td>
